...
This manual serves to clearly define a process for initiating changes to products, services and processes, by opening an issue. There are a few different kinds of issues. This manual explains what issues there are, when and where to open a certain kind of issue, and how an issue can advance to the next stage and finally be closed.
